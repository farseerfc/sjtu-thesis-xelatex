...
% 字号选项: c5size 五号(默认)
% 字号选项: cs4size 小四
\documentclass[a4paper, c5size, twoside]{sjtuphd} 
% 单面打印
% \documentclass[a4paper, cs4size, oneside, openany]{sjtuphd} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  % 中文封面内容
  \title{上海交通大学博士学位论文~\LaTeX~模板~\version}
  \author{李四}
  \advisor{张三教授}
  \degree{博士}
  \defenddate{2~0~0~9~年~10~月~16~日}
  \school{上海交通大学}
  \institute{物理系}
  ...
  % 英文封面内容
  \englishtitle{\LaTeX\, Template for SJTU Ph.D Thesis \version}
